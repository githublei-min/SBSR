...
parser = argparse.ArgumentParser(description='SBSR')
...
# Data specifications
parser.add_argument('--root', type=str, default='./datasets/ntire21/burstsr/synthetic',
...
parser.add_argument('--chop', action='store_false',
                    help='enable memory-efficient forward')
parser.add_argument('--no_augment', action='store_true',
                    help='do not use data augmentation')

# Model specifications
parser.add_argument('--model', default='BSRT',
                    help='model name')

parser.add_argument('--act', type=str, default='relu',
                    help='activation function')
parser.add_argument('--pre_train', type=str, default='./best_epoch.pth',
...
parser.add_argument('--decay', type=str, default='50-100',
